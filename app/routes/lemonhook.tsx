...
export const action = async ({ request }: ActionArgs) => {
	...
	// console.log(eventName, event.data.attributes);
	// console.log('------------------------------------------------------------');
	if (event.meta.event_name === 'order_created') {
		console.log('order_created', event.data.attributes);
	}

	if (event.meta.event_name === 'subscription_created') {
		console.log('subscription_created', event.data.attributes);
	}

	if (event.meta.event_name === 'subscription_updated') {
		console.log('subscription_updated', event.data.attributes);
	}
