...
export const getWorkspaceFilesById = (workspaceId: Workspace['id'], from: Date | undefined = undefined, to: Date | undefined = undefined, order: "asc" | "desc" = "asc", isPublic: "yes" | "no" = "no", userId: User["id"]) => {
  return prisma.workspace.findUnique({
    where: {
      id: workspaceId
    },
...
export const isUserAllowedViewWorkspace = async (userId: User["id"], workspaceId: Workspace["id"]) => {
